...
<head>
  ...
  <style>
    ...
    .profile-details {
      margin-top: 0;
      margin-left: 20px;
      /* Penambahan jarak kiri antara foto, bio, dan tombol */
    }
    ...
    .profile-bio {
      margin-top: 10px;
      /* Penambahan jarak atas antara foto dan bio */
      font-size: 16px;
      max-width: 1000px;
      color: #777;
    }
  ...
  ?>
    <div class="container-post">
      ...
      <div class="container-isi">
        <p><?= $post['deskripsi'] ?></p>
        <img src="<?php echo $post['foto']; ?>" alt="Profile Picture" style="width :100px;">
      </div>
      <div class="container-isi">
